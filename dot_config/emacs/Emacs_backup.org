...
(set-face-attribute 'default nil :font "Fira Code Retina" :height bevsxyz/default-font-size)

;; Set the fixed pitch face
(set-face-attribute 'fixed-pitch nil :font "Fira Code Retina" :height bevsxyz/default-font-size)

;; Set the variable pitch face
(set-face-attribute 'variable-pitch nil :font "Cantarell" :height bevsxyz/default-variable-font-size :weight 'regular)
...
#+begin_src emacs-lisp
  ...
  (use-package general
    ...
    (bevsxyz/leader-keys
      ...
      "fde" '(lambda () (interactive) (find-file (expand-file-name "~/.local/share/chezmoi/dot_config/emacs/Emacs.org")))))
...
#+begin_src emacs-lisp
  ...
  (use-package elfeed
    :bind ("C-x w" . elfeed)
    :custom (elfeed-show-entry-switch 'display-buffer)
    (rmh-elfeed-org-files '("~/projects/orgfiles/elfeed.org")))
...
#+begin_src emacs-lisp
  ...
  (defun elfeed-lynx-open (&optional use-generic-p)
    "open with eww"
    (interactive "P")
...
#+begin_src emacs-lisp
  (use-package bibtex
    :bind (:map bibtex-mode-map ("H-b" . 'org-ref-bibtex-hydra/body)))
  (setq bibtex-completion-bibliography '("~/projects/emacs/bibliography/references.bib"
                                         "~/projects/emacs/bibliography/dei.bib"
                                         "~/projects/emacs/bibliography/master.bib"
                                         "~/projects/emacs/bibliography/archive.bib")
        bibtex-completion-library-path '("~/projects/emacs/bibliography/bibtex-pdfs/")
        bibtex-completion-notes-path "~/projects/emacs/bibliography/notes/"
...
Settings for reading and annotating pdf files in emacs.
...
#+begin_src emacs-lisp
  (use-package pdf-tools
    ...
    (setq-default pdf-view-set-slice-from-bounding-box)
    :custom (pdf-view-image-relief 1))

    ;; midnite mode hook
    (add-hook 'pdf-view-mode-hook (lambda ()
                                    (pdf-view-midnight-minor-mode)
                                    (blink-cursor-mode -1))) ; automatically turns on midnight-mode for pdfs
#+end_src
...
#+begin_src emacs-lisp
  ...
  (defun bevsxyz/lsp-mode-setup ()
    (setq lsp-headerline-breadcrumb-segments '(path-up-to-project file symbols))
    (lsp-headerline-breadcrumb-mode))

  (use-package lsp-mode
    :commands (lsp lsp-deferred)
    :hook (lsp-mode . bevsxyz/lsp-mode-setup)
    :init
...
#+begin_src emacs-lisp
  ...
  (defun bevsxyz/configure-eshell ()
  ...
  (use-package eshell
    :hook (eshell-first-time-mode . bevsxyz/configure-eshell)
    :config
...
I use[[https://www.chezmoi.io/][ chezmoi]] to manage my dotfiles. There is the emacs extension [[https://github.com/tuh8888/chezmoi.el][chezmoi.el]] to for emacs integration.
